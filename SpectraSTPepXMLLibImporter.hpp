...
private:
  ...
  unsigned int m_numQueryWithProb;
  ...
  bool readOneScan(cRamp* cramp, int scanNum, SpectraSTLibEntry* entry, string& fullFileName, bool silent = false, double minMz = 0.0, double maxMz = 999999.9);
